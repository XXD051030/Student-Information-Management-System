<%@ Page Language="C#" MasterPageFile="~/student/StudentLayout.master" AutoEventWireup="true" CodeBehind="material_preview.aspx.cs" Inherits="src.shared.material_preview" Title="Material Preview - INTI Portal" %>
...
<asp:Content ContentPlaceHolderID="MainContent" runat="server">
    <div class="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
        ...
        <asp:HyperLink ID="primaryActionLink" runat="server" CssClass="inline-flex h-10 items-center justify-center gap-1.5 rounded-md bg-[#e0162b] px-4 text-white hover:bg-[#a01020]" style="font-size:13px;font-weight:700">
            <i data-lucide="download" class="h-4 w-4"></i><asp:Literal ID="primaryActionText" runat="server" />
        </asp:HyperLink>
    </div>
    ...
    <asp:Panel ID="previewPanel" runat="server" Visible="false" CssClass="mt-6 overflow-hidden rounded-lg border border-slate-200 bg-white">
        <div class="flex items-center justify-between border-b border-slate-100 px-5 py-3">
            ...
            <span class="text-slate-400" style="font-size:12px"><asp:Literal ID="fileSizeLabel" runat="server" /></span>
        </div>
        <div class="min-h-[70vh] bg-slate-100 p-4">
            <iframe ID="previewFrame" runat="server" title="Material preview" class="h-[70vh] w-full rounded-md border border-slate-200 bg-white"></iframe>
            <asp:Panel ID="limitedPreviewPanel" runat="server" Visible="false" CssClass="flex min-h-[55vh] items-center justify-center rounded-md border border-slate-200 bg-white px-6 py-10 text-center text-slate-600" style="font-size:13px">
                <div>
                    ...
                    <p class="mt-3 text-slate-900" style="font-size:15px;font-weight:700">Inline preview is not available for this file type.</p>
                    <p class="mt-1"><asp:Literal ID="limitedPreviewMessage" runat="server" /></p>
                </div>
            </asp:Panel>
        </div>
    </asp:Panel>
