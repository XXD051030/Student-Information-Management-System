    ...
    <section class="mt-6 grid gap-6 lg:grid-cols-3">
        ...
        <div class="lg:col-span-2 rounded-2xl border border-slate-200 bg-white">
            ...
            <asp:Repeater ID="scheduleRepeater" runat="server">
                ...
                <ItemTemplate>
                    <li>
                        <a href='<%# AttendanceUrl(Eval("OfferingId")) %>' class="flex items-center gap-4 px-6 py-4 hover:bg-slate-50/60 transition-colors">
        ...
        <div class="rounded-2xl border border-slate-200 bg-white">
            ...
            <div class="border-t border-slate-100 p-3">
                <a runat="server" href="~/lecturer/lecturer_grades.aspx?source=dashboard" class="block w-full rounded-xl py-2.5 text-center text-slate-700 hover:bg-slate-50 transition-colors" style="font-size:13px;font-weight:600">
