<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="admin_topbar.ascx.cs" Inherits="src.controls.admin_topbar" %>
...
<header class="sticky top-0 z-30 flex h-16 items-center gap-3 border-b border-slate-200 bg-white/80 px-6 backdrop-blur-md">
    ...
    <div class="ml-auto flex items-center gap-2.5 rounded-full border border-slate-200 bg-white py-1 pl-3 pr-1">
        ...
        <span class="flex h-8 w-8 items-center justify-center rounded-full bg-slate-900 text-white" style="font-size:13px;font-weight:600">
