<%@ Page Language="C#" MasterPageFile="~/shared/DashboardLayout.master" AutoEventWireup="true" CodeBehind="dashboard.aspx.cs" Inherits="student_information_management_system.dashboard" Title="Dashboard - INTI Student Portal" %>
...
<asp:Content ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div class="relative flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
            <div class="max-w-xl">
                ...
                <p class="mt-2 text-white/75" style="font-size:15px;line-height:1.6">
                    You have <span class="text-white font-semibold">4 classes</span> today and <span class="text-white font-semibold">3 assignments</span> due this week. Keep going &mdash; you're on track.
                </p>
            </div>
    ...
    <section class="mt-6 grid grid-cols-2 gap-4 xl:grid-cols-4">
        ...
        <div class="group rounded-2xl border border-slate-200 bg-white p-5 hover:border-slate-300 hover:shadow-sm transition-all">
            ...
            <p class="mt-3 text-slate-400" style="font-size:12px">vs last semester</p>
        </div>
        ...
        <div class="group rounded-2xl border border-slate-200 bg-white p-5 hover:border-slate-300 hover:shadow-sm transition-all">
            ...
            <p class="mt-3 text-slate-400" style="font-size:12px">65% completed</p>
        </div>
        ...
        <div class="lg:col-span-2 rounded-2xl border border-slate-200 bg-white p-6">
            ...
            <ul class="grid gap-3 sm:grid-cols-2">
                ...
                <li class="group rounded-xl border border-slate-200 p-4 hover:border-slate-300 hover:shadow-sm transition-all cursor-pointer">
                    ...
                    <p class="mt-0.5 text-slate-500" style="font-size:12px">Dr. Lim Wei Han</p>
                </li>
                ...
                <li class="group rounded-xl border border-slate-200 p-4 hover:border-slate-300 hover:shadow-sm transition-all cursor-pointer">
                    ...
                    <p class="mt-0.5 text-slate-500" style="font-size:12px">Ms. Tan Hui Ying</p>
                </li>
                ...
                <li class="group rounded-xl border border-slate-200 p-4 hover:border-slate-300 hover:shadow-sm transition-all cursor-pointer">
                    ...
                    <p class="mt-0.5 text-slate-500" style="font-size:12px">Ms. Sarah Choo</p>
                </li>
