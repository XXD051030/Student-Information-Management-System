<%@ Page Language="C#" MasterPageFile="~/shared/DashboardLayout.master" AutoEventWireup="true" CodeBehind="account.aspx.cs" Inherits="student_information_management_system.account" Title="Account - INTI Student Portal" %>
    ...
    <div class="mt-6 space-y-5">
        ...
        <section class="rounded-lg border border-slate-200 bg-white">
            ...
            <div class="px-6 py-6">
                ...
                <form id="profile-form" onsubmit="return false" class="mt-6 grid gap-4 sm:grid-cols-2">
                    ...
                    <%-- Read-only: Current standing (wide) --%>
                    <div class="sm:col-span-2">
                        <span class="inline-flex items-center gap-1.5 text-slate-500" style="font-size:11.5px;font-weight:600;letter-spacing:0.04em">
                    ...
                    <div class="sm:col-span-2 flex items-center justify-end gap-2 pt-2">
                        ...
                        <button type="submit" id="profile-save-btn" class="inline-flex items-center gap-1.5 rounded-md bg-[#e0162b] px-4 h-10 text-white hover:bg-[#a01020] transition-colors shadow-[0_8px_18px_-10px_rgba(224,22,43,0.6)]" style="font-size:13px;font-weight:600">Save changes</button>
                    </div>
                </form>
            </div>
        </section>
        ...
        <section class="rounded-lg border border-slate-200 bg-white">
            ...
            <form id="password-form" onsubmit="return false" class="px-6 py-6 grid gap-4 sm:grid-cols-2">
                ...
                <%-- Message slot --%>
                <div id="pw-msg" class="hidden sm:col-span-2 items-start gap-2 rounded-md border px-3 py-2" style="font-size:12.5px">
                ...
                <div class="sm:col-span-2 flex items-center justify-end gap-2 pt-1">
                    <button type="submit" id="pw-submit-btn" class="inline-flex items-center gap-1.5 rounded-md bg-[#e0162b] px-4 h-10 text-white hover:bg-[#a01020] transition-colors shadow-[0_8px_18px_-10px_rgba(224,22,43,0.6)]" style="font-size:13px;font-weight:600">Update password</button>
                </div>
            </form>
        </section>
        ...
        <section class="rounded-lg border border-[#e0162b]/20 bg-[#e0162b]/5 px-6 py-5 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            <a href="login.aspx" class="inline-flex items-center justify-center gap-1.5 rounded-md bg-[#e0162b] px-4 h-10 text-white hover:bg-[#a01020] transition-colors shadow-[0_8px_18px_-10px_rgba(224,22,43,0.6)]" style="font-size:13px;font-weight:600">
                <i data-lucide="log-out" class="h-4 w-4"></i> Sign out
            </a>
        </section>
