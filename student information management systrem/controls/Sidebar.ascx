...
<aside id="mobile-menu" data-open="false" class="flex fixed inset-y-0 left-0 z-50 w-64 shrink-0 flex-col border-r border-slate-200 bg-white -translate-x-full transition-transform duration-300 data-[open=true]:translate-x-0 lg:static lg:translate-x-0">
    ...
    <nav class="flex-1 overflow-y-auto px-3 py-5">
        ...
        <ul class="space-y-0.5">
            ...
            <li>
                <a href="/student/academic/courses.aspx" data-nav-link="courses.aspx" class="group flex items-center gap-3 rounded-xl px-3 py-2.5 transition-all text-slate-600 hover:bg-slate-50 hover:text-slate-900 data-[active=true]:bg-[#e0162b]/10 data-[active=true]:text-[#a01020] data-[active=true]:font-semibold" style="font-size:14px;font-weight:500">
                    <i data-lucide="book-open" class="h-4 w-4 text-slate-400 group-hover:text-slate-700"></i>
                    <span class="flex-1">My Courses</span>
                    <span class="rounded-md px-1.5 bg-slate-100 text-slate-600" style="font-size:11px;font-weight:600">6</span>
                </a>
            ...
            <li>
                <a href="/student/academic/enrollment.aspx" data-nav-link="enrollment.aspx" class="group flex items-center gap-3 rounded-xl px-3 py-2.5 transition-all text-slate-600 hover:bg-slate-50 hover:text-slate-900 data-[active=true]:bg-[#e0162b]/10 data-[active=true]:text-[#a01020] data-[active=true]:font-semibold" style="font-size:14px;font-weight:500">
            ...
            <li>
                <details open>
                    ...
                    <ul class="mt-0.5 ml-7 border-l border-slate-100 pl-3 space-y-0.5">
                        <li><a href="/student/finance/payment.aspx" data-nav-link="payment.aspx" class="block rounded-lg px-3 py-2 transition-all text-slate-600 hover:bg-slate-50 hover:text-slate-900 data-[active=true]:bg-[#e0162b]/10 data-[active=true]:text-[#a01020] data-[active=true]:font-semibold" style="font-size:13px;font-weight:500">Payment</a></li>
                        <li><a href="/student/finance/payment-history.aspx" data-nav-link="payment-history.aspx" class="block rounded-lg px-3 py-2 transition-all text-slate-600 hover:bg-slate-50 hover:text-slate-900 data-[active=true]:bg-[#e0162b]/10 data-[active=true]:text-[#a01020] data-[active=true]:font-semibold" style="font-size:13px;font-weight:500">Payment History</a></li>
                    </ul>
                </details>
            </li>
            <li>
                <a href="/student/academic/timetable.aspx" data-nav-link="timetable.aspx" class="group flex items-center gap-3 rounded-xl px-3 py-2.5 transition-all text-slate-600 hover:bg-slate-50 hover:text-slate-900 data-[active=true]:bg-[#e0162b]/10 data-[active=true]:text-[#a01020] data-[active=true]:font-semibold" style="font-size:14px;font-weight:500">
                    <i data-lucide="calendar-days" class="h-4 w-4 text-slate-400 group-hover:text-slate-700"></i>
                    <span class="flex-1">Timetable</span>
                </a>
            </li>
            <li>
                <a href="/student/academic/assignments.aspx" data-nav-link="assignments.aspx" class="group flex items-center gap-3 rounded-xl px-3 py-2.5 transition-all text-slate-600 hover:bg-slate-50 hover:text-slate-900 data-[active=true]:bg-[#e0162b]/10 data-[active=true]:text-[#a01020] data-[active=true]:font-semibold" style="font-size:14px;font-weight:500">
            ...
            <li>
                <a href="/student/academic/grades.aspx" data-nav-link="grades.aspx" class="group flex items-center gap-3 rounded-xl px-3 py-2.5 transition-all text-slate-600 hover:bg-slate-50 hover:text-slate-900 data-[active=true]:bg-[#e0162b]/10 data-[active=true]:text-[#a01020] data-[active=true]:font-semibold" style="font-size:14px;font-weight:500">
                    <i data-lucide="graduation-cap" class="h-4 w-4 text-slate-400 group-hover:text-slate-700"></i>
                    <span class="flex-1">Grades</span>
                </a>
            </li>
            ...
            <li>
                <a href="/student/academic/attendance.aspx" data-nav-link="attendance.aspx" class="group flex items-center gap-3 rounded-xl px-3 py-2.5 transition-all text-slate-600 hover:bg-slate-50 hover:text-slate-900 data-[active=true]:bg-[#e0162b]/10 data-[active=true]:text-[#a01020] data-[active=true]:font-semibold" style="font-size:14px;font-weight:500">
                    <i data-lucide="user-check" class="h-4 w-4 text-slate-400 group-hover:text-slate-700"></i>
                    <span class="flex-1">Attendance</span>
                </a>
            </li>
    ...
    <div class="border-t border-slate-100 p-3">
        <a href="/shared/login.aspx" class="flex w-full items-center gap-3 rounded-xl px-3 py-2.5 text-slate-600 hover:bg-slate-50 hover:text-[#e0162b] transition-colors" style="font-size:14px;font-weight:500">
