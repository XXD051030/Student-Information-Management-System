...
<asp:Content ContentPlaceHolderID="MainContent" runat="server">
    ...
    <section class="mt-6 grid gap-6 lg:grid-cols-3">
        ...
        <aside class="rounded-2xl border border-slate-200 bg-white p-6">
            ...
            <%-- Pay button --%>
            <button id="pay-btn"
                    class="mt-4 inline-flex w-full items-center justify-center gap-2 rounded-xl px-5 h-12 bg-[#e0162b] text-white hover:bg-[#a01020] shadow-[0_8px_20px_-8px_rgba(224,22,43,0.55)] transition-all"
                    style="font-size:14px;font-weight:700">
                <i data-lucide="credit-card" class="h-4 w-4"></i>
                Pay RM <span id="pay-btn-amount">0.00</span>
            </button>
...
<asp:Content ContentPlaceHolderID="ScriptsPlaceholder" runat="server">
    <script src="<%= ResolveUrl("~/js/payment/payment.js") %>"></script>
</asp:Content>
